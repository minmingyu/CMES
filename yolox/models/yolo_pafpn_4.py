...
class YOLOPAFPN_4(nn.Module):
    ...
    def forward(self, input):
        ...
        # 修改---------------------------------------------
        # 增加dark2层
        fpn_out0 = self.lateral_conv0(x0)  # 普通卷积，1024->512/32
        f_out0 = self.upsample(fpn_out0)  # 上采样，512/16
        ...
        outputs = (pan_out3, pan_out2, pan_out1)
        # -------------------------------------------------
